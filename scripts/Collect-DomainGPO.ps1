<#
.SYNOPSIS
    Domain GPO Collection Script
    Collects all Group Policy Objects from Active Directory and POSTs to the Inventory Web API.
    Must be run on a Domain Controller or a machine with the GroupPolicy module installed.
